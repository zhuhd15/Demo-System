...
from .spider3 import SpiderRenewerALL
...
def store_pic(img_url, info):
    # create new folder
    path = os.getcwd()
    path = path+"/System/Spider/Imgbase/From_website/"
...
def SpiderRenewer(info,caffemodel):
    ...
    if department == 0 or department =='http://www.ee.tsinghua.edu.cn' :
        ...
        new_info = SpiderRenewerALL(department,caffemodel)
        return [1,new_info]
    return new_info
